            ...
            <div className="container">
                ...
                <div className="collapse navbar-collapse z-index-lg" id="navbarCollapse">
                    ...
                    <ul className="navbar-nav ms-auto">
                        ...
                        <li className="nav-item ">
                            <Link className="nav-link px-xl-4" to="/courses" id="navbarLandings">
                                Courses
                            </Link>
                        ...
                        <li className="nav-item ">
                            <Link className="nav-link px-xl-4" to="/about" id="navbarLandings">
                                About Us
                            </Link>
                        </li>
                        <li className="nav-item ">
                            <Link className="nav-link px-xl-4" to="/contact" id="navbarLandings">
                                Contact Us
                            </Link>
                        </li>
                        <li className="nav-item ">
                ...
                <ul className="navbar-nav flex-row ms-auto ms-xl-0 me-n2 me-md-n4 align-items-center">
                    ...
                    <li className="nav-item border-0 px-0">
                        ...
                        <Link to="#" className="nav-link d-flex px-3 px-md-4 position-relative text-white-all icon-xs" data-bs-toggle="modal" data-bs-target="#cartModal">
                            <span className="badge badge-white text-primary rounded-circle fw-bold badge-float mt-n1 ms-n2 px-0 w-16">2</span>
                            {/* <!-- Icon --> */}
