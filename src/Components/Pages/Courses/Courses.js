                    ...
                    <div className="col-md pb-4 pb-md-7">
                        ...
                        <div className="card border shadow p-2 lift sk-fade">
                            ...
                            <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                                ...
                                {/* <!-- Preheading --> */}
                                <Link to="/course-single"><span className="mb-1 d-inline-block text-gray-800">Development</span></Link>

                                {/* <!-- Heading --> */}
                                <div className="position-relative">
                                    <Link to="/course-single" className="d-block stretched-link"><h4 className="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">The Complete JavaScript Course 2020: Build Real Projects!</h4></Link>
                    ...
                    <div className="col-md pb-4 pb-md-7">
                        ...
                        <div className="card border shadow p-2 lift sk-fade">
                            ...
                            <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                                ...
                                {/* <!-- Preheading --> */}
                                <Link to="/course-single"><span className="mb-1 d-inline-block text-gray-800">Photography</span></Link>

                                {/* <!-- Heading --> */}
                                <div className="position-relative">
                                    <Link to="/course-single" className="d-block stretched-link"><h4 className="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Learn Figma: User Interface Design Essentials - UI/UX Design</h4></Link>
                    ...
                    <div className="col-md pb-4 pb-md-7">
                        ...
                        <div className="card border shadow p-2 lift sk-fade">
                            ...
                            <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                                ...
                                {/* <!-- Heading --> */}
                                <div className="position-relative">
                                    <Link to="/course-single" className="d-block stretched-link"><h4 className="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">The Complete Financial Analyst Course 2020</h4></Link>
                    ...
                    <div className="col-md pb-4 pb-md-7">
                        ...
                        <div className="card border shadow p-2 lift sk-fade">
                            ...
                            <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                                ...
                                {/* <!-- Heading --> */}
                                <div className="position-relative">
                                    <Link to="/course-single" className="d-block stretched-link"><h4 className="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Fashion Photography From Professional</h4></Link>
                        ...
                        <div className="card border shadow p-2 lift sk-fade">
                            ...
                            <div className="card-zoom position-relative">
                                <div className="badge-float sk-fade-top top-0 right-0 mt-4 me-4">
                                    <Link to="/course-single" className="btn btn-xs btn-dark text-white rounded-circle lift opacity-dot-7 me-1 p-2 d-inline-flex justify-content-center align-items-center w-36 h-36">
                                        {/* <!-- Icon --> */}
                                    ...
                                    <Link to="/course-single" className="btn btn-xs btn-dark text-white rounded-circle lift opacity-dot-7 p-2 d-inline-flex justify-content-center align-items-center w-36 h-36">
                                        {/* <!-- Icon --> */}
                                        <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                                ...
                                {/* <!-- Heading --> */}
                                <div className="position-relative">
                                    <Link to="/course-single" className="d-block stretched-link"><h4 className="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Unity Medical Visualization: 03 Deployment and Usability</h4></Link>
                    ...
                    <div className="col-md pb-4 pb-md-7">
                        ...
                        <div className="card border shadow p-2 lift sk-fade">
                            ...
                            <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                                ...
                                {/* <!-- Heading --> */}
                                <div className="position-relative">
                                    <Link to="/course-single" className="d-block stretched-link"><h4 className="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Cubase Pro 10 Essential Training: Advanced</h4></Link>
