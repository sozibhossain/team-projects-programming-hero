...
const CheckoutFormAndOrder = () => {
                    ...
                    <table class="shop_table woocommerce-checkout-review-order-table">
                        ...
                        <tfoot>
                            <tr class="cart-subtotal">
                                <th>Subtotal</th>
                                <td><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$</span>109.95</span></td>
                            </tr>

                            <tr class="order-total">
                                <th>Total</th>
                                <td><strong><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$</span>109.95</span></strong> </td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
   ...
   {/*  <!-- CALL ACTION
    ================================================== --> */}
    <section class="py-6 py-md-11 border-top border-bottom" data-jarallax data-speed=".8" style={{backgroundImage: "url(assets/img/illustrations/illustration-1.jpg)"}}>
...
export default CheckoutFormAndOrder;