...
const CourseSingle = () => {
    ...
    <div className="container">
        <nav className="mb-5 mb-md-8 mt-2" aria-label="breadcrumb">
    ...
    <div className="container">
        <div className="row mb-8">
            <div className="col-lg-8 mb-6 mb-lg-0 position-relative">
                <h1 className="me-xl-14">
                    Learn Figma: User Interface Design Essentials - UI/UX Design
                </h1>
                <p className="me-xl-13 mb-5">Master Figma app to get a job in UI Design, User Interface, User Experience design, Web Design & UX design.</p>

                <a href="#" className="badge badge-lg badge-rounded-circle badge-secondary font-size-base badge-float badge-float-inside top-0 text-white">
                ...
                <div className="d-md-flex align-items-center mb-5">
                    <div className="border rounded-circle d-inline-block mb-4 mb-md-0 me-md-6 me-lg-4 me-xl-6">
                        <div className="p-2">
                            <img src="assets/img/avatars/avatar-1.jpg" alt="..." className="rounded-circle" width="68" height="68"/>
                        </div>
                    </div>

                    <div className="mb-4 mb-md-0 me-md-8 me-lg-4 me-xl-8">
                        <h6 className="mb-0">Created by</h6>
                        <a href="#" className="font-size-sm text-gray-800">Alison Dawn</a>
                    </div>

                    <div className="mb-4 mb-md-0 me-md-8 me-lg-4 me-xl-8">
                        <h6 className="mb-0">Categories</h6>
                        <a href="#" className="font-size-sm text-gray-800">Design</a>
                    </div>

                    <div className="mb-4 mb-md-0 me-md-6 me-lg-4 me-xl-6">
                        ...
                        <div className="d-lg-flex align-items-center">
                            ...
                            <div className="font-size-sm ms-lg-3">
                ...
                <a href="https://www.youtube.com/watch?v=9I-Y6VQ6tyI" className="d-block sk-thumbnail rounded mb-6" data-fancybox>
                    <div className="h-90p w-90p rounded-circle bg-white size-30-all d-inline-flex align-items-center justify-content-center position-absolute center z-index-1">
                        {/* <!-- Icon --> */}
                ...
                {/* <!-- COURSE INFO TAB
                ================================================== --> */}
                <div className="border rounded shadow p-3 mb-6">
                    <ul id="pills-tab" className="nav nav-pills course-tab-v2 h5 mb-0 flex-nowrap overflow-auto" role="tablist">
                        <li className="nav-item">
                            <a className="nav-link active" id="pills-overview-tab" data-bs-toggle="pill" href="#pills-overview" role="tab" aria-controls="pills-overview" aria-selected="true">Overview</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" id="pills-curriculum-tab" data-bs-toggle="pill" href="#pills-curriculum" role="tab" aria-controls="pills-curriculum" aria-selected="false">Curriculum</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" id="pills-instructor-tab" data-bs-toggle="pill" href="#pills-instructor" role="tab" aria-controls="pills-instructor" aria-selected="false">Curriculum</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" id="pills-reviews-tab" data-bs-toggle="pill" href="#pills-reviews" role="tab" aria-controls="pills-reviews" aria-selected="false">Reviews</a>
                        </li>
                    </ul>
                </div>
                ...
                <div className="tab-content" id="pills-tabContent">
                        ...
                        <div id="accordionCurriculum">
                                ...
                                <div id="CurriculumcollapseOne" className="collapse show" aria-labelledby="curriculumheadingOne" data-parent="#accordionCurriculum">
                                    <div className="border-top px-5 py-4 min-height-70 d-md-flex align-items-center">
                                        ...
                                        <div className="d-flex align-items-center overflow-auto overflow-md-visible flex-shrink-all">
                                            <div className="badge text-dark-70 bg-orange-40 me-5 font-size-sm fw-normal py-2">3 question</div>
                                            <div className="badge btn-blue-soft me-5 font-size-sm fw-normal py-2">30 min</div>
                                    ...
                                    <div className="border-top px-5 py-4 min-height-70 d-md-flex align-items-center bg-gray-100">
                                        <div className="d-flex align-items-center me-auto mb-4 mb-md-0">
                                            <div className="text-secondary d-flex">
                                                <svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M12.5717 0H4.16956C4.05379 0.00594643 3.94322 0.0496071 3.85456 0.124286L0.413131 3.57857C0.328167 3.65957 0.280113 3.77191 0.280274 3.88929V16.8514C0.281452 17.4853 0.794988 17.9988 1.42885 18H12.5717C13.1981 17.9989 13.7086 17.497 13.7203 16.8707V1.14857C13.7191 0.514714 13.2056 0.00117857 12.5717 0ZM8.18099 0.857143H10.6988V4.87714L9.80527 3.45214C9.76906 3.39182 9.71859 3.3413 9.65827 3.30514C9.45529 3.18337 9.19204 3.24916 9.07027 3.45214L8.18099 4.87071V0.857143ZM3.7367 1.46786V2.66143C3.73552 3.10002 3.38029 3.45525 2.9417 3.45643H1.74813L3.7367 1.46786ZM12.8546 16.86C12.8534 17.0157 12.7274 17.1417 12.5717 17.1429H1.42885C1.42665 17.1429 1.42445 17.143 1.42226 17.143C1.26486 17.1441 1.13635 17.0174 1.13527 16.86V4.32214H2.9417C3.85793 4.31979 4.60006 3.57766 4.60242 2.66143V0.857143H7.31527V5.23286C7.31345 5.42593 7.37688 5.61391 7.49527 5.76643C7.67533 5.99539 7.98036 6.08561 8.25599 5.99143L8.28813 5.98071C8.49272 5.89484 8.66356 5.7443 8.77456 5.55214L9.44099 4.48071L10.1074 5.55214C10.2184 5.7443 10.3893 5.89484 10.5938 5.98071C10.8764 6.0922 11.1987 6.00509 11.3867 5.76643C11.5051 5.61391 11.5685 5.42593 11.5667 5.23286V0.857143H12.5717C12.7266 0.858268 12.8523 0.982982 12.8546 1.13786V16.86Z" fill="currentColor"/>
                                    ...
                                    <div className="border-top px-5 py-4 min-height-70 d-md-flex align-items-center bg-gray-100">
                                        ...
                                        <div className="d-flex align-items-center overflow-auto overflow-md-visible flex-shrink-all">
                                            <div className="me-5 font-size-sm">12 lectures</div>
                                            <div className="badge btn-blue-soft me-5 font-size-sm fw-normal py-2">30 min</div>
                            ...
                            <div className="border rounded shadow mb-6 overflow-hidden">
                                <div className="d-flex align-items-center" id="curriculumheadingTwo">
                                    <h5 className="mb-0 w-100">
                                        <button className="d-flex align-items-center p-5 min-height-80 text-dark fw-medium collapse-accordion-toggle line-height-one" type="button" data-bs-toggle="collapse" data-bs-target="#CurriculumcollapseTwo" aria-expanded="true" aria-controls="CurriculumcollapseTwo">
                                            <span className="me-4 text-dark d-flex">
                                                {/* <!-- Icon --> */}
                                                <svg width="15" height="2" viewBox="0 0 15 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <rect width="15" height="2" fill="currentColor"/>
                                ...
                                <div id="CurriculumcollapseTwo" className="collapse show" aria-labelledby="curriculumheadingTwo" data-parent="#accordionCurriculum">
                                    <div className="border-top px-5 py-4 min-height-70 d-md-flex align-items-center">
                                        <div className="d-flex align-items-center me-auto mb-4 mb-md-0">
                                            <div className="text-secondary d-flex">
                                                <svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="border-top px-5 py-4 min-height-70 d-md-flex align-items-center bg-gray-100">
                                        ...
                                        <div className="d-flex align-items-center overflow-auto overflow-md-visible flex-shrink-all">
                                            <div className="me-5 font-size-sm">12 lectures</div>
                                            <div className="badge text-dark-70 bg-orange-40 me-5 font-size-sm fw-normal py-2">5 question</div>
                                            <div className="badge btn-blue-soft me-5 font-size-sm fw-normal py-2">45 min</div>
                                            <div className="text-secondary d-flex">
                                                {/* <!-- Icon --> */}
                                                <svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M15.625 7.34375H7.3423V4.13164C7.3423 2.715 8.53391 1.5625 9.99855 1.5625C11.4632 1.5625 12.6548 2.715 12.6548 4.13164V5.625H14.2173V4.13164C14.2173 1.85344 12.3248 0 9.99855 0C7.67234 0 5.7798 1.85344 5.7798 4.13164V7.34375H4.375C3.08266 7.34375 2.03125 8.39516 2.03125 9.6875V17.6562C2.03125 18.9486 3.08266 20 4.375 20H15.625C16.9173 20 17.9688 18.9486 17.9688 17.6562V9.6875C17.9688 8.39516 16.9173 7.34375 15.625 7.34375ZM16.4062 17.6562C16.4062 18.087 16.0558 18.4375 15.625 18.4375H4.375C3.94422 18.4375 3.59375 18.087 3.59375 17.6562V9.6875C3.59375 9.25672 3.94422 8.90625 4.375 8.90625H15.625C16.0558 8.90625 16.4062 9.25672 16.4062 9.6875V17.6562Z" fill="currentColor"/>
                                    ...
                                    <div className="border-top px-5 py-4 min-height-70 d-md-flex align-items-center">
                                        ...
                                        <div className="d-flex align-items-center overflow-auto overflow-md-visible flex-shrink-all">
                                            <button className="btn btn-sm btn-blue-soft me-5 font-size-sm fw-normal py-1">30 min</button>
                                            <a href="#" className="text-secondary">
                                                {/* <!-- Icon --> */}
                                                <svg width="14" height="16" viewBox="0 0 14 16" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M12.8704 6.15374L3.42038 0.328572C2.73669 -0.0923355 1.9101 -0.109836 1.20919 0.281759C0.508282 0.673291 0.0898438 1.38645 0.0898438 2.18929V13.7866C0.0898438 15.0005 1.06797 15.9934 2.27016 16C2.27344 16 2.27672 16 2.27994 16C2.65563 16 3.04713 15.8822 3.41279 15.6591C3.70694 15.4796 3.79991 15.0957 3.62044 14.8016C3.44098 14.5074 3.05697 14.4144 2.76291 14.5939C2.59188 14.6982 2.42485 14.7522 2.27688 14.7522C1.82328 14.7497 1.33763 14.3611 1.33763 13.7866V2.18933C1.33763 1.84492 1.51713 1.53907 1.81775 1.3711C2.11841 1.20314 2.47294 1.21064 2.76585 1.39098L12.2159 7.21615C12.4999 7.39102 12.6625 7.68262 12.6618 8.01618C12.6611 8.34971 12.4974 8.64065 12.2118 8.81493L5.37935 12.9983C5.08548 13.1783 4.9931 13.5623 5.17304 13.8562C5.35295 14.1501 5.73704 14.2424 6.03092 14.0625L12.8625 9.87962C13.5166 9.48059 13.9081 8.78496 13.9096 8.01868C13.9112 7.25249 13.5226 6.55524 12.8704 6.15374Z" fill="currentColor"/>
                            ...
                            <div className="border rounded shadow mb-6 overflow-hidden">
                                <div className="d-flex align-items-center" id="curriculumheadingThree">
                                    <h5 className="mb-0 w-100">
                                        <button className="d-flex align-items-center p-5 min-height-80 text-dark fw-medium collapse-accordion-toggle line-height-one" type="button" data-bs-toggle="collapse" data-bs-target="#CurriculumcollapseThree" aria-expanded="false" aria-controls="CurriculumcollapseThree">
                                            <span className="me-4 text-dark d-flex">
                                                {/* <!-- Icon --> */}
                                                <svg width="15" height="2" viewBox="0 0 15 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <rect width="15" height="2" fill="currentColor"/>
                            ...
                            <div className="border rounded shadow mb-6 overflow-hidden">
                                <div className="d-flex align-items-center" id="curriculumheadingFour">
                                    <h5 className="mb-0 w-100">
                                        <button className="d-flex align-items-center p-5 min-height-80 text-dark fw-medium collapse-accordion-toggle line-height-one" type="button" data-bs-toggle="collapse" data-bs-target="#CurriculumcollapseFour" aria-expanded="false" aria-controls="CurriculumcollapseFour">
                                            <span className="me-4 text-dark d-flex">
                                                {/* <!-- Icon --> */}
                                                <svg width="15" height="2" viewBox="0 0 15 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <rect width="15" height="2" fill="currentColor"/>
                    ...
                    <div className="tab-pane fade" id="pills-instructor" role="tabpanel" aria-labelledby="pills-instructor-tab">
                        ...
                        <div className="d-flex align-items-center mb-6">
                            ...
                            <div className="media-body">
                                <h4 className="mb-0">Lauren Handerson</h4>
                        ...
                        <p className="mb-6 line-height-md">I am a UI/UX designer and an iOS developer with having almost six years of experience in application development and also ten years of graphic design and User Interface design.</p>
                    ...
                    <div className="tab-pane fade" id="pills-reviews" role="tabpanel" aria-labelledby="pills-reviews-tab">
                        ...
                        <div className="row align-items-center mb-8">
                            <div className="col-md-auto mb-5 mb-md-0">
                                <div className="border rounded shadow d-flex align-items-center justify-content-center px-9 py-8">
                                    <div className="m-2 text-center">
                                        <h1 className="display-2 mb-0 fw-medium mb-n1">4.93</h1>
                            ...
                            <div className="col-md">
                                <div className="d-md-flex align-items-center my-3 my-md-4">
                                    <div className="bg-gray-200 position-relative rounded-pill flex-grow-1 me-md-5 mb-2 mb-md-0 mw-md-260p" style={{height:"10px"}}>
                                        <div className="bg-teal rounded-pill position-absolute top-0 left-0 bottom-0" style={{width:"90%"}}></div>
                                    </div>

                                    <div className="d-flex align-items-center">
                                        <div className="star-rating star-rating-lg secondary me-4">
                                            <div className="rating" style={{width:"90%"}}></div>
                                        </div>
                                        <span>4132</span>
                                    </div>
                                </div>
                                ...
                                <div className="d-md-flex align-items-center my-3 my-md-4">
                                    <div className="bg-gray-200 position-relative rounded-pill flex-grow-1 me-md-5 mb-2 mb-md-0 mw-md-260p" style={{height:"10px"}}>
                                        <div className="bg-teal rounded-pill position-absolute top-0 left-0 bottom-0" style={{width:"60%"}}></div>
                                    </div>
                                ...
                                <div className="d-md-flex align-items-center my-3 my-md-4">
                                    <div className="bg-gray-200 position-relative rounded-pill flex-grow-1 me-md-5 mb-2 mb-md-0 mw-md-260p" style={{height:"10px"}}>
                                        <div className="bg-teal rounded-pill position-absolute top-0 left-0 bottom-0" style={{width:"50%"}}></div>
                                    </div>
                                ...
                                <div className="d-md-flex align-items-center my-3 my-md-4">
                                    <div className="bg-gray-200 position-relative rounded-pill flex-grow-1 me-md-5 mb-2 mb-md-0 mw-md-260p" style={{height:"10px"}}>
                                        <div className="bg-teal rounded-pill position-absolute top-0 left-0 bottom-0" style={{width:"35%"}}></div>
                                    </div>

                                    <div className="d-flex align-items-center">
                                        <div className="star-rating star-rating-lg secondary me-4">
                                            <div className="rating" style={{width:"35%"}}></div>
                                        </div>
                                        <span>32</span>
                                    </div>
                                </div>
                                ...
                                <div className="d-md-flex align-items-center my-3 my-md-4">
                                    <div className="bg-gray-200 position-relative rounded-pill flex-grow-1 me-md-5 mb-2 mb-md-0 mw-md-260p" style={{height:"10px"}}>
                                        <div className="bg-teal rounded-pill position-absolute top-0 left-0 bottom-0" style={{width:"15%"}}></div>
                                    </div>

                                    <div className="d-flex align-items-center">
                                        <div className="star-rating star-rating-lg secondary me-4">
                                            <div className="rating" style={{width:"15%"}}></div>
                                        </div>
                                        <span>1</span>
                                    </div>
                                </div>
            ...
            <div className="col-lg-4">
                {/* <!-- SIDEBAR FILTER
                ================================================== --> */}
                <div className="d-block rounded border p-2 shadow mb-6">
                    <a href="https://www.youtube.com/watch?v=9I-Y6VQ6tyI" className="d-none sk-thumbnail rounded mb-1" data-fancybox>
                    ...
                    <div className="pt-5 pb-4 px-5 px-lg-3 px-xl-5">
                        ...
                        <button className="btn btn-primary btn-block mb-3" type="button" name="button">BUY NOW</button>
                        <button className="btn btn-orange btn-block mb-6" type="button" name="button">ENROLL</button>
                        ...
                        <ul className="list-group list-group-flush">
                            ...
                            <li className="list-group-item d-flex align-items-center py-3">
                                ...
                                <h6 className="mb-0 ms-3 me-auto">Lectures</h6>
                                <span>32</span>
                            </li>
                            <li className="list-group-item d-flex align-items-center py-3">
                                <div className="text-secondary d-flex icon-uxs">
                                ...
                                <h6 className="mb-0 ms-3 me-auto">Enrolled</h6>
                            ...
                            <li className="list-group-item d-flex align-items-center py-3">
                                ...
                                <h6 className="mb-0 ms-3 me-auto">Language</h6>
                                <span>English</span>
                            </li>
                            <li className="list-group-item d-flex align-items-center py-3">
                                <div className="text-secondary d-flex icon-uxs">
                                ...
                                <h6 className="mb-0 ms-3 me-auto">Skill level</h6>
                                <span>beginner</span>
                            </li>
                            <li className="list-group-item d-flex align-items-center py-3">
                                <div className="text-secondary d-flex icon-uxs">
                                ...
                                <h6 className="mb-0 ms-3 me-auto">Deadline</h6>
                            ...
                            <li className="list-group-item d-flex align-items-center py-3">
                                ...
                                <h6 className="mb-0 ms-3 me-auto">Certificate</h6>
                                <span>Yes</span>
                            </li>
                            <li className="list-group-item d-flex align-items-center py-4">
                                <a href="course-single-v5.html" className="mx-auto text-teal fw-medium d-flex align-items-center mt-2">
                                    {/* <!-- Icon --> */}
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ul className="list-unstyled mb-0">
                            <li className="media mb-6 d-flex">
                                <a href="course-single-v5.html" className="w-100p d-block me-5">
                                    <img src="assets/img/photos/photo-1.jpg" alt="..." className="avatar-img rounded-lg h-90p w-100p"/>
                                </a>
                                <div className="media-body flex-grow-1">
                                    <a href="course-single-v5.html" className="d-block">
                                        <h6 className="line-clamp-2 mb-3">Web Developtment and Design</h6>
                                    </a>
                            ...
                            <li className="media mb-6 d-flex">
                                <a href="course-single-v5.html" className="w-100p d-block me-5">
                                    <img src="assets/img/photos/photo-2.jpg" alt="..." className="avatar-img rounded-lg h-90p w-100p"/>
                                </a>
                                <div className="media-body flex-grow-1">
                                    <a href="course-single-v5.html" className="d-block">
                                        <h6 className="line-clamp-2 mb-3">The Complete Cyber Security Course : Hackers </h6>
                                    </a>
                                    <del className="font-size-sm me-2">$959</del>
                                    <ins className="h6 mb-0 ">$415.99</ins>
                                </div>
                            ...
                            <li className="media mb-6 d-flex">
                                <a href="course-single-v5.html" className="w-100p d-block me-5">
                                    <img src="assets/img/photos/photo-14.jpg" alt="..." className="avatar-img rounded-lg h-90p w-100p"/>
                                </a>
                                <div className="media-body flex-grow-1">
                                    <a href="course-single-v5.html" className="d-block">
                                        <h6 className="line-clamp-2 mb-3">Fashion Photography From Professional</h6>
                                    </a>
                                    <del className="font-size-sm me-2">$959</del>
                                    <ins className="h6 mb-0 ">$415.99</ins>
                                </div>
                            ...
                            <li className="media mb-6 d-flex">
                                <a href="course-single-v5.html" className="w-100p d-block me-5">
                                    <img src="assets/img/photos/photo-16.jpg" alt="..." className="avatar-img rounded-lg h-90p w-100p"/>
                                </a>
                                <div className="media-body flex-grow-1">
                                    <a href="course-single-v5.html" className="d-block">
                                        <h6 className="line-clamp-2 mb-3">The Complete Financial Analyst Course 2020</h6>
                                    </a>
                                    <del className="font-size-sm me-2">$959</del>
                                    <ins className="h6 mb-0 ">$415.99</ins>
                                </div>
        ...
        <div className="mx-n4 mb-12" data-flickity='{"pageDots": true, "prevNextButtons": false, "cellAlign": "left", "wrapAround": true, "imagesLoaded": true}'>
            <div className="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style={{paddingRight:"15px",paddingLeft:"15px"}}>
                {/* <!-- Card --> */}
                <div className="card border shadow-dark-hover p-2 sk-fade">
                    {/* <!-- Image --> */}
                    <div className="card-zoom position-relative">
                        <a href="course-single-v5.html" className="card-img sk-thumbnail img-ratio-3 d-block">
                    ...
                    <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        <div className="position-relative">
                            <a href="course-single-v5.html" className="d-block stretched-link"><h5 className="line-clamp-2 h-md-48 h-lg-58 me-md-8 me-lg-10 me-xl-4 mb-2">Fashion Photography From Professional</h5></a>
            ...
            <div className="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style={{paddingRight:"15px",paddingLeft:"15px"}}>
                ...
                <div className="card border shadow-dark-hover p-2 sk-fade">
                    ...
                    <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        {/* <!-- Preheading --> */}
                        <a href="course-single-v5.html"><span className="mb-1 d-inline-block text-gray-800">Marketing</span></a>

                        {/* <!-- Heading --> */}
                        <div className="position-relative">
                            <a href="course-single-v5.html" className="d-block stretched-link"><h5 className="line-clamp-2 h-md-48 h-lg-58 me-md-8 me-lg-10 me-xl-4 mb-2">Productivity and Time Management for workplace</h5></a>
            ...
            <div className="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style={{paddingRight:"15px",paddingLeft:"15px"}}>
                ...
                <div className="card border shadow-dark-hover p-2 sk-fade">
                    ...
                    <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        {/* <!-- Preheading --> */}
                        <a href="course-single-v5.html"><span className="mb-1 d-inline-block text-gray-800">Personal Development</span></a>

                        {/* <!-- Heading --> */}
                        <div className="position-relative">
                            <a href="course-single-v5.html" className="d-block stretched-link"><h5 className="line-clamp-2 h-md-48 h-lg-58 me-md-8 me-lg-10 me-xl-4 mb-2">Learn Ethical Hacking From Scratch</h5></a>
            ...
            <div className="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style={{paddingRight:"15px",paddingLeft:"15px"}}>
                ...
                <div className="card border shadow-dark-hover p-2 sk-fade">
                    ...
                    <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        {/* <!-- Heading --> */}
                        <div className="position-relative">
                            <a href="course-single-v5.html" className="d-block stretched-link"><h5 className="line-clamp-2 h-md-48 h-lg-58 me-md-8 me-lg-10 me-xl-4 mb-2">The Complete JavaScript Course 2020: Real Projects!</h5></a>
