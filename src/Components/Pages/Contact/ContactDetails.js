                    ...
                    <div className="col-xl mb-6">
                        <div className="media d-flex">
                            ...
                            <div className="media-body flex-shrink-1">
                                ...
                                <a href="tel:3159052321" className="text-gray-800 d-block">+(315) 905-2321</a>
                                <a href="tel:3159052322" className="text-gray-800 d-block">+(315) 905-2322</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-xl mb-6">
                        <div className="media d-flex">
                            ...
                            <div className="media-body flex-shrink-1">
                                ...
                                <a href="mailto:info@skola.com" className="text-gray-800">info@skola.com</a>
                                <br/>
                                <a href="mailto:courses@skola.com" className="text-gray-800">courses@skola.com</a>
                            </div>
                        </div>
                    </div>
            ...
            <div className="col-md">
                ...
                <form className="row">
                    <div className="form-group mb-6 col-xl-6">
                        ...
                        <input type="text" className="form-control placeholder-1" id="exampleInputTitle1" placeholder=""/>
                    </div>

                    <div className="form-group mb-6 col-xl-6">
                        <label for="exampleInputTitle2">Email</label>
                        <input type="email" className="form-control placeholder-1" id="exampleInputTitle2" placeholder=""/>
                    </div>
